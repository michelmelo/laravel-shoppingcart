...
[![License](https://poser.pugx.org/michelmelo/laravel-shoppingcart/license)](https://packagist.org/packages/michelmelo/laravel-shoppingcart)
...
Add a new line to the `providers` array:
	...
	MichelMelo\Shoppingcart\ShoppingcartServiceProvider::class

And optionally add a new line to the `aliases` array:

	'Cart' => MichelMelo\Shoppingcart\Facades\Cart::class,
...
The path to the `Buyable` interface is:
    ...
    MichelMelo\Shoppingcart\Contracts\Buyable;
